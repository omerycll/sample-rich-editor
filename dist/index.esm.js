...
var RichTextEditor = function (_a) {
    ...
    var _f = useState(initialContent); _f[0]; var setContent = _f[1];
    ...
    return (React.createElement("div", { className: "simple-rich-editor ".concat(className || ''), style: style },
        React.createElement("div", { className: "simple-rich-editor-toolbar" },
            ...
            isLinkModalOpen && (React.createElement("div", { className: "link-modal" },
                React.createElement("input", { type: "text", value: linkUrl, onChange: function (e) { return setLinkUrl(e.target.value); }, onKeyDown: handleKeyDown, placeholder: "Ba\u011Flant\u0131 URL'si", autoFocus: true }),
                React.createElement("button", { onClick: insertLink }, "Ekle"),
